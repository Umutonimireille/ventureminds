        ...
        <div className="container-max">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
                ...
                <div className="flex gap-4">
                  {socialLinks.map((social) => (
                    <motion.a
                      key={social.name}
                      href={social.url}
                      className="w-12 h-12 rounded-xl border flex items-center justify-center text-sm font-bold transition-colors"
                      style={{ backgroundColor: 'rgba(242, 147, 46, 0.08)', borderColor: 'rgba(242, 147, 46, 0.25)', color: '#F2932E' }}
                      whileHover={{ scale: 1.1, y: -2, borderColor: '#F2932E' }}
                      onMouseEnter={() => {
                        setIsHovering(true)
              ...
              <div className="rounded-2xl overflow-hidden border aspect-video" style={{ backgroundColor: 'rgba(30, 127, 191, 0.08)', borderColor: 'rgba(30, 127, 191, 0.2)' }}>
                <iframe
